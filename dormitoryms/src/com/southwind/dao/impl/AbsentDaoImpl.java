...
public class AbsentDaoImpl implements AbsentDao {
    ...
    public Integer save(Absent absent) {
        ...
        //准备执行sql注意空
        String sql="insert into absent(building_id,dormitory_id,student_id,dormitory_admin_id,create_date,reason) value(?,?,?,?,?,?)";
    ...
    public List<Absent> list() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                list.add(new Absent(id,buildingName,dormitoryName,studentName,reason,dormitoryAdminName,createDate));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }finally {
