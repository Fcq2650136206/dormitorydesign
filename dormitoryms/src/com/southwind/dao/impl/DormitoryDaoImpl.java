...
public class DormitoryDaoImpl implements DormitoryDao {
    ...
    public List<Dormitory> availableList() {
        ...
        Connection connection = JDBCUtil.getConnection();
        //准备执行sql注意空
        String sql="select d.id,d.name from dormitory d where available>0";
        PreparedStatement statement=null;
        ResultSet resultSet=null;
        List<Dormitory> list = new ArrayList<>();
        try {
    ...
    @Override
    public Integer delete(Integer dormitoryId) {
        //获取连接
        Connection connection = JDBCUtil.getConnection();
        //准备执行sql注意空
        String sql="delete from dormitory where id="+dormitoryId;
        PreparedStatement statement=null;
        Integer result=null;
        try {
            statement=connection.prepareStatement(sql);
    ...
    public Integer save(Dormitory dormitory) {
        ...
        Connection connection = JDBCUtil.getConnection();
        //准备执行sql注意空
        String sql="insert into dormitory(building_id,name,type,available,telephone) value(?,?,?,?,?)";
        PreparedStatement statement=null;
        Integer result=null;
        try {
            statement=connection.prepareStatement(sql);
