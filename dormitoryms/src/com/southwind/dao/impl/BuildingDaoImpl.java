...
public class BuildingDaoImpl implements BuildingDao {
    ...
    public List<Building> list() {
        ...
        //准备执行sql
        String sql="select b.id,b.name,b.introduction,d.name,b.admin_id from building b,dormitory_admin d where b.admin_id=d.id";
    ...
    public List<Building> search(String key,String value) {
        ...
        Connection connection = JDBCUtil.getConnection();
        //准备执行sql
        String sql="select b.id,b.name,b.introduction,d.name,b.admin_id from building b,dormitory_admin d where b.admin_id=d.id and b."+key+" like '%"+value+"%'";
        PreparedStatement statement=null;
        ResultSet resultSet=null;
        List<Building> list = new ArrayList<>();
        try {
    ...
    public Integer save(Building building) {
        ...
        Connection connection = JDBCUtil.getConnection();
        //准备执行sql注意空
        String sql="insert into building(name,introduction,admin_id) value(?,?,?)";
        PreparedStatement statement=null;
        Integer result=null;
        try {
            statement=connection.prepareStatement(sql);
