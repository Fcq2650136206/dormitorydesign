...
public class StudentDaoImpl implements StudentDao {
    ...
    public Integer save(Student student) {
        ...
        Connection connection = JDBCUtil.getConnection();
        //准备执行sql注意空
        String sql="insert into student(number,name,gender,dormitory_id,state,create_date) value(?,?,?,?,?,?)";
        PreparedStatement statement=null;
        Integer result=null;
        try {
            statement=connection.prepareStatement(sql);
    ...
    public List<Integer> findStudentIdByDormitoryId(Integer dormitoryId) {
        ...
        Connection connection = JDBCUtil.getConnection();
        //准备执行sql
        String sql="select id from student where dormitory_id="+dormitoryId;
        PreparedStatement statement=null;
        ResultSet resultSet=null;
    ...
    @Override
    public Integer exchange(Integer studentId, Integer availableDormitoryId) {
        //获取连接
        Connection connection = JDBCUtil.getConnection();
        //准备执行sql注意空
        ...
        try {
            statement=connection.prepareStatement(sql);
            statement.setInt(1,availableDormitoryId);
    ...
    @Override
    public Integer stateForMoveout(Integer studentId) {
        //获取连接
        Connection connection = JDBCUtil.getConnection();
        //准备执行sql注意空
        String sql="update student set state='迁出' where id="+ studentId;
        PreparedStatement statement=null;
        Integer result=null;
        try {
            statement=connection.prepareStatement(sql);
